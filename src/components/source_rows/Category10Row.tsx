...
import { EmissionSource, Cat10CalculationMethod, CO2eFactorFuel, EmissionCategory, DataQualityIndicator } from '../../types';
    ...
    return (
        <div className="flex flex-col gap-2 p-3 bg-gray-50 rounded-lg border dark:bg-gray-800 dark:border-gray-600">
            ...
            <MethodologyWizard
                ...
                onSelectMethod={(method) => handleMethodChange(method as Cat10CalculationMethod)}
            />
        </div>
    );
};
