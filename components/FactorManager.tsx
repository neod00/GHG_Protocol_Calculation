...
export const FactorManager: React.FC<FactorManagerProps> = ({ 
    ...
    const tabClasses = (tab: ActiveTab) =>
        `px-3 py-2 text-sm font-medium rounded-t-lg transition-colors focus:outline-none ${
        activeTab === tab
        ...
        switch (activeTab) {
            ...
            case 'Scope 3': 
                ...
                return (
                    <div>
                        <div className="mb-4">
                            <label htmlFor="scope3-cat-select" className="block text-sm font-medium text-gray-700 dark:text-gray-300">Select Scope 3 Category</label>
                        ...
                        {categoryKey ? renderFactorList(categoryKey) : <p>Category not supported for custom factors.</p>}
                    </div>
                );
            default: return null;
        }
