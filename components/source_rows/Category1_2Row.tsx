      ...
      {isExpanded && <div className="flex flex-col gap-3 pt-3 border-t dark:border-gray-600">
          ...
          <div>
              ...
              <div className="flex gap-2">
                  ...
                  />
                  <button onClick={handleAnalyze} disabled={isLoadingAI || !source.fuelType} className="px-3 py-2 bg-ghg-light-green text-white rounded-md hover:bg-ghg-green disabled:bg-gray-400 flex items-center gap-2">
