    ...
    <div className={cardClasses}>
      ...
      {isOpen && !isDisabled && (
        <div className="px-6 pb-6 flex flex-col flex-grow">
          {(category === EmissionCategory.ProcessEmissions || category === EmissionCategory.PurchasedEnergy || category === EmissionCategory.FuelAndEnergyRelatedActivities || category === EmissionCategory.UpstreamTransportationAndDistribution || category === EmissionCategory.PurchasedGoodsAndServices || category === EmissionCategory.CapitalGoods || category === EmissionCategory.WasteGeneratedInOperations || category === EmissionCategory.BusinessTravel || category === EmissionCategory.EmployeeCommuting) && (
