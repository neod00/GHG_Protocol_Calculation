...
const en = {
  ...
  'UseOfSoldProducts': '11. Use of Sold Products',
...
const ko = {
  ...
  processingOfSoldProductsPlaceholder: '예: 당사 원자재를 이용한 부품 외주 가공',
  ...
  // Category 1 & 2 Advanced UI
  editDetails: '상세 정보 수정',
  calculationMethod: '산정 방식',
  supplierMethod: '공급업체 데이터',
  ...
  justification: '분류 근거',
  confirm: '확인',
  aiDisclaimer: 'AI 제안은 참고용입니다. 정확성을 직접 확인해주세요.',
  capitalGoodsInfoTitle: '자본재 산정 핵심 원칙',
  capitalGoodsInfoDepreciation: '<strong>전체 일시 인식:</strong> 자본재 배출량은 취득 연도에 전액 보고해야 합니다. 감가상각 방식을 사용하지 마십시오.',
  capitalGoodsInfoCategorization: '<strong>정확한 카테고리 분류:</strong> 유지보수 비용은 카테고리 1, 관련 운송은 카테고리 4, 건설 중 사용된 연료는 Scope 1 또는 Scope 3, 카테고리 3에 해당합니다.',
  capitalGoodsInfoScope: '<strong>산정 범위:</strong> 기계, 장비, 건물, 시설, 차량 등 구매한 모든 자본재가 포함됩니다.',
  dataQuality: '데이터 품질',
  assumptionsNotes: '가정 및 참고사항',
  assumptionsNotesPlaceholder: '예: 배출계수 산정을 위해 평균적인 자재 구성을 가정함.',
  qualityHigh: '높음 (예: 공급업체별 EPD)',
  qualityMedium: '중간 (예: 산업 평균 데이터)',
  qualityLow: '낮음 (예: 금액 기반 추정치)',
  qualityEstimated: '추정치',

  // Category 3 Advanced UI
  s3c3autoGeneratedDescription: 'Scope 2 에너지 소비 데이터(WTT + 송배전 손실)를 기반으로 자동 계산됩니다.',
  s3c3autoGeneratedFuelType: '구매 에너지의 업스트림 배출량',
  activityType: '활동 유형',
  fuelWTT: '업스트림 연료 배출 (WTT)',
  spendBased: '기타 (비용/활동량/공급업체 기반)',

  // Category 4 Advanced UI
  fuelMethod: '연료 기반',
  supplier_specificMethod: '공급업체 제공 데이터',
  transportMode: '운송 모드',
  vehicleType: '차량/선박 유형',
  distance: '총 거리',
  weight: '총 중량',
  refrigeratedTransport: '온도조절 운송(냉장/냉동)',
  loadFactor: '적재율 (%)',
  emptyBackhaul: '빈차 운행(Empty Backhaul)',
  adjustmentFactors: '보정 계수',
  cat4FuelType: '연료 유형',
  ...
  freightSpend: '화물 운송 서비스 (비용 기반)',
  warehousingSpend: '창고 보관 (비용 기반)',
};
