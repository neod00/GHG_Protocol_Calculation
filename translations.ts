...
const en = {
  ...
  newBadge: 'New',
  complexFactorsNotEditableTitle: 'Complex Factors Not Editable',
  complexFactorsNotEditableBody: 'This category uses structured factors (e.g., by transport mode, waste type) which are not editable through this simplified interface. The values are based on GHG Protocol standard sources.',
...
const ko = {
  ...
  vehicle: '차량',
  serviceType: '서비스 유형',
  airTravelSpend: '항공 (지출)',
  railTravelSpend: '철도 (지출)',
  groundTransportSpend: '육상 교통 (지출)',
  hotelSpend: '숙박 (지출)',
  hotelNational: '호텔 숙박 (국내)',
  hotelInternational: '호텔 숙박 (해외)',
  railHighSpeed: '고속철도',
  carDiesel: '자동차 (평균 디젤)',
  carElectric: '자동차 (전기)',
  ...
  newBadge: '신규',
  complexFactorsNotEditableTitle: '복합 계수 편집 불가',
  complexFactorsNotEditableBody: '이 카테고리는 이 간소화된 인터페이스를 통해 편집할 수 없는 구조화된 계수(예: 운송 수단, 폐기물 유형별)를 사용합니다. 값은 GHG 프로토콜 표준 출처를 기반으로 합니다.',
  activityBasedFactors: '활동량 기반 계수',
